...
const STRINGS = {
  "en-US": {
    ...
    "auth.okRegistered": "Registered — token saved, starting the collector…",
    "auth.okLoggedIn": "Signed in — token saved, starting the collector…",
  ...
  "zh-CN": {
    ...
    "auth.okRegistered": "注册成功,Token 已保存,正在启动 collector…",
    "auth.okLoggedIn": "登录成功,Token 已保存,正在启动 collector…",
    "update.text": "新版本",
    "update.available": "可用。",
