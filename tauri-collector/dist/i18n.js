...
const STRINGS = {
  "en-US": {
    ...
    "field.serverUrl.placeholder": "https://mem.example.com",
    ...
    "field.token.hint": "Get this from Settings → Users → Reset collector token on the web UI.",
  ...
  "zh-CN": {
    ...
    "field.token.hint": "在 Web UI 上 Settings → Users → 重置 collector token 获取。",
