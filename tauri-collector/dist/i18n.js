...
const STRINGS = {
  "en-US": {
    ...
    "field.token.placeholder": "paste the token from the admin console",
    "field.token.hint": "Shown right after you register on the Memento website — copy it from there.",
    ...
    "auth.or": "No token? Register or sign in here — no browser needed",
    "auth.email": "Email",
    "auth.password": "Password",
    "auth.invite": "Invite code (optional)",
    "auth.register": "Register & get token",
    "auth.login": "Sign in & get token",
    "auth.hint": "We fill the token in for you and start syncing — set the Server URL above first.",
    "auth.working": "Working…",
    "auth.needUrl": "Enter the Server URL first.",
    "auth.needCreds": "Email and password are required.",
    "auth.okRegistered": "Registered — token saved. Review the options below, then click Start collector.",
    "auth.okLoggedIn": "Signed in — token saved. Review the options below, then click Start collector.",
  ...
  "zh-CN": {
    ...
    "field.token": "Collector Token",
    "field.token.placeholder": "从管理后台粘贴 token",
    "field.token.hint": "在 Memento 网站注册完成后会直接显示,从那里复制即可。",
    ...
    "dashboard.back": "⚙ 设置",
    "auth.or": "没有 Token?直接在这注册或登录 —— 不用开浏览器",
    "auth.email": "邮箱",
    "auth.password": "密码",
    "auth.invite": "邀请码(可选)",
    "auth.register": "注册并获取 Token",
    "auth.login": "登录并获取 Token",
    "auth.hint": "成功后自动填好 Token 并开始采集 —— 请先填上面的服务器地址。",
    "auth.working": "处理中…",
    "auth.needUrl": "请先填服务器地址。",
    "auth.needCreds": "邮箱和密码不能为空。",
    "auth.okRegistered": "注册成功,Token 已保存。检查下方选项后,点「启动 collector」。",
    "auth.okLoggedIn": "登录成功,Token 已保存。检查下方选项后,点「启动 collector」。",
    "update.text": "新版本",
    "update.available": "可用。",
